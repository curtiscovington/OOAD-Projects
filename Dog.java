public class Dog extends Pet {
    ...
    public Dog(String name, double purchasePrice, double listPrice, double salePrice, int dayArrived, int daySold, String breed, int age, boolean healthy, int size, String color, boolean housebroken, boolean purebred) {
